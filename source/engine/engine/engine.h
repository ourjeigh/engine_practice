...
public:
	...
	void render_draw_rect(const t_render_shape_rect rect, const c_color color);
	...
	void render_draw_circle(const s_render_shape_circle circle, c_color color, bool fill);
