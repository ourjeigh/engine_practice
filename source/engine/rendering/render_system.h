...
public:
	...
	void draw_bitmap(const s_bitmap_asset& bitmap, const s_render_shape_rect& rect, e_render_layer layer);
...
inline void render_system_draw_bitmap(const s_bitmap_asset& bitmap, const s_render_shape_rect& rect, e_render_layer layer) { c_render_system::get().draw_bitmap(bitmap, rect, layer); }
