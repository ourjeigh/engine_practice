...
struct i_engine
{
	...
	virtual bool load_asset(const s_asset_definition* asset_def, f_asset_loaded_callback* callback, void* object);
	...
	virtual void render_draw_bitmap(const s_bitmap_asset bitmap, int32 x, int32 y, e_render_layer layer) = 0;
...
inline s_asset* engine_get_asset(c_string_id asset_id) {/* TODO */}
...
inline void engine_render_bitmap(const s_bitmap_asset bitmap, int32 x, int32 y, e_render_layer layer) { g_engine_ptr->render_draw_bitmap(bitmap, x, y, layer); }
